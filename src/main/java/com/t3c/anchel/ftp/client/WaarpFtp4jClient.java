 ...
 */
package com.t3c.anchel.ftp.client;
...
public class WaarpFtp4jClient {
	...
	public WaarpFtp4jClient(String server, int port, String user, String pwd, String acct, boolean isPassive, int ssl,
		...
		try
	    {
	      ...
	      InputStream inputStream = WaarpFtp4jClient.class.getClassLoader().getResourceAsStream("./linshare.properties");
	      properties.load(inputStream);
	      String linshare_host = properties.getProperty("com.sgs.linshare.url");
	      String ipAddress = InetAddress.getByName(linshare_host).getHostAddress();
	      logger.info("Linshare_Container IPAddress: " + ipAddress);
